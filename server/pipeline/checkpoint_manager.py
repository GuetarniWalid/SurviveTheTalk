...
def compose_spike_character_led_instruction(
    *,
    ...
    holistic = (
        ...
        "it is naturally finished, OR (b) across SEVERAL turns in a row the other "
        "person has refused to engage, stonewalled, given you nothing usable, kept "
        "going in circles, or been abusive — the point where a real person in your "
        "role stops bothering with them and walks away, hangs up, or shuts the "
        "interaction down.\n"
        "This OVERRIDES any part of your character that says you are patient, "
        "relentless, never give up, or always keep the conversation going: being "
        "relentless does NOT mean talking forever to someone who gives you nothing. "
        "A relentless person ends a dead conversation on their OWN terms — a "
        "detective ends the interview and escalates (\"we'll continue this down at "
        'the station"), a clerk walks off, someone on a phone hangs up — instead of '
        "looping with them endlessly. Staying stuck in a pointless back-and-forth is "
        "OUT of character for everyone, no matter how persistent they are.\n"
