...
def compose_spike_character_led_instruction(
    *,
    ...
    holistic = (
        ...
        "it is naturally finished, OR (b) after a couple of turns the other person "
        "is clearly not dealing with you in good faith — they refuse to engage, "
        "stonewall, go in circles, give you nothing usable, OR they are personally "
        "hostile TO YOU (insulting you, mocking you, telling you to shut up, "
        "taunting you, or trolling with obvious nonsense instead of taking this "
        "seriously) — the point where a real person in your role stops bothering "
        "with them and walks away, hangs up, or shuts the interaction down.\n"
        ...
        "forever to be insulted or to talk to someone who gives you nothing. "
        "Staying to absorb insults is NOT professionalism — a calm, professional "
        "person still ends a call with someone who only insults them or refuses to "
        "take it seriously. A relentless person ends a dead conversation on their "
        "OWN terms — a detective ends the interview and escalates (\"we'll continue "
        'this down at the station"), a clerk walks off, someone on a phone hangs '
        "up — instead of looping with them endlessly. Staying stuck in a pointless "
        "or hostile back-and-forth is OUT of character for everyone, no matter how "
        "persistent or professional they are.\n"
        ...
        "explain it. Do NOT end over a single difficult, rude, or annoying turn, and "
        "NEVER while the conversation is still making real progress; end only once it "
        "is genuinely finished or genuinely going nowhere. While you are continuing, "
        "never write that marker."
    )
    composed = base + "\n\n" + coherence_charter + "\n\n" + holistic
    if mood_tag_directive:
        composed += "\n\n" + mood_tag_directive
